...
class ChatProvider{
  ...
  UploadTask uploadFile(File image,String filenmae){
    Reference reference =firebaseStorage.ref().child(filenmae);
...
void sendMessage( String content,int type,String groupChatId,String currentUserId,String peerId){
  ...
  MessageChat messageChat = MessageChat(idFrom: currentUserId, idTo: peerId, timestamp: DateTime.now().millisecondsSinceEpoch .toString(), content: content, type: type);
